...
public:
	...
	void setVec2(const std::string &name, const Vector2 &v2) const {
	...
	// ------------------------------------------------------------------------
	void setVec3(const std::string &name, const Vector3 &v3) const {
	...
	// ------------------------------------------------------------------------
	void setVec4(const std::string &name, const Vector4 &v4) const {
	...
	//}
	// ------------------------------------------------------------------------
	void setMat3(const std::string &name, const Matrix3 &m3) const {
		glUniformMatrix3fv(glGetUniformLocation(ID, name.c_str()), 1, GL_FALSE, m3);
	}
	// ------------------------------------------------------------------------
	void setMat4(const std::string &name, const Matrix4 &m4) const {
